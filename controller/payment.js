...
const getPaymentReference = (event) => {
  if (event.data.object.reference) {
    return event.data.object.reference;
  } else if (event.data.object.authorization.reference) {
    return event.data.object.authorization.reference;
  }
};
